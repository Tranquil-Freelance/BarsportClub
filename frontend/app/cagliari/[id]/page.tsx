...
export async function generateStaticParams() {
  return cagliariArticles.map((a) => ({ id: a.id }));
}

export default async function CagliariArticlePage({ params }: Props) {
  const { id } = await params;
  const article = cagliariArticles.find((a) => a.id === id);
