...
import { cagliariArticles } from "@/app/cagliari/data";
...
export default function CagliariPage() {
  const [hero, ...grid] = cagliariArticles;
        ...
        <div className="max-w-[1120px] mx-auto px-5 py-5 flex items-end justify-between gap-4">
          <div>
            ...
            <p className="font-heading text-[12px] font-black uppercase tracking-[0.1em] text-[#0a192f]">
              CAGLIARI CALCIO · STAGIONE 2025/26
            </p>
          </div>
          <Link
            href="/"
            ...
            {grid.map((article) => (
              <article key={article.id}>
                <div className="group block h-full">
                  ...
                  {/* Text */}
                  <Link href={`/cagliari/${article.id}`} className="block cursor-pointer">
