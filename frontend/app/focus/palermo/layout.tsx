      ...
      <footer className="mt-16 border-t border-pink-900/30 bg-black/50 py-8">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col items-center justify-between gap-6 md:flex-row">
            <div className="text-center md:text-left">
              ...
              <p className="mt-2 max-w-md text-sm text-zinc-400">
                Unabhängige Analyseplattform für Palermo FC. Daten von Opta,
                Advanced Analytics Engine und offiziellen Serie-B-Quellen.
              </p>
            </div>
          ...
          <div className="mt-8 text-center text-xs text-zinc-500">
            © 2026 xPalermoStat. Dies ist ein Fan-Projekt, nicht verbunden mit
            Palermo FC.
          </div>
        </div>
      </footer>
