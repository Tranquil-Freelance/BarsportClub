...
export async function generateStaticParams() {
  return lecceArticles.map((a) => ({ id: a.id }));
}

export default async function LecceArticlePage({ params }: Props) {
  const { id } = await params;
  const article = lecceArticles.find((a) => a.id === id);
