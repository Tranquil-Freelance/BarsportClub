...
import { lecceArticles } from "@/app/lecce/data";
...
export default function LeccePage() {
  const [hero, ...grid] = lecceArticles;
            ...
            {grid.map((article) => (
              <article key={article.id}>
                <div className="group block h-full">
                  ...
                  {/* Text */}
                  <Link href={`/lecce/${article.id}`} className="block cursor-pointer">
